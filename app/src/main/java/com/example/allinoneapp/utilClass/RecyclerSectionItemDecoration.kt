...
class RecyclerSectionItemDecoration(
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (headerView == null) {
            ...
            header = headerView!!.findViewById<View>(com.example.allinoneapp.R.id.list_item_section_text) as TextView
...
//            Log.e("title", title.toString())
    ...
    private fun inflateHeaderView(parent: RecyclerView): View {
        return LayoutInflater.from(parent.context)
            .inflate(com.example.allinoneapp.R.layout.recycler_section_header, parent, false)
    }
